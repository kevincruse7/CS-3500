 ...
 */
public final class EasyAnimatorSVGView implements EasyAnimatorView {

  /**
   * Instantiates an {@code EasyAnimatorSVGView} object with the given model and output appendable.
   *
   ...
   */
  public EasyAnimatorSVGView(EasyAnimatorModel<?, ?> model, Appendable output, int leftmostX,
